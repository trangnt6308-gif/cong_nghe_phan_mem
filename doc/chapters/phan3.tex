...
\begin{itemize}
  ...
  \item \textbf{Ứng dụng di động (Mobile App):} Dành cho Khách hàng và Nhân viên vận hành trạm.
        Cho phép tạo đơn, theo dõi giao hàng và xác nhận hoàn tất.
  \item \textbf{RESTful API:} Phục vụ trao đổi dữ liệu giữa các thành phần front-end, mobile
...
\begin{itemize}
  \item Giao diện Web và di động phải tương thích tốt với nhiều loại thiết bị và độ phân giải màn hình khác nhau (Responsive Design).
...
\begin{itemize}
  \item Hệ thống phải hoạt động trên nền tảng web và ứng dụng di động (iOS và Android).
