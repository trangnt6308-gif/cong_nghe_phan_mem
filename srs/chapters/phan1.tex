...
\begin{itemize}
  ...
  \item \textbf{Thời gian thực hiện:} 8 tuần, triển khai theo mô hình Scrum gồm 6 Sprint
  \item \textbf{Công nghệ chính:} ReactJS, Python Flask, Supabase cho cơ sở dữ liệu và xác thực, LLM API của Groq
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Tính năng:}
    \begin{itemize}
      \item Quản lý và điều phối nhiều drone tại nhiều trạm
      \item Hỗ trợ bay ngoài tầm nhìn trực quan BVLOS
      \item Bảng điều khiển giám sát thời gian thực bao gồm pin, kết nối và cảnh báo an toàn
    \end{itemize}
  ...
  \item \textbf{Nhược điểm:} Không có nghiệp vụ hướng đến khách hàng cuối bao gồm tạo đơn, quản lý kiện hàng, xác nhận nhận hàng, hỗ trợ AI cho khách hàng; đòi hỏi đội ngũ vận hành drone chuyên nghiệp để sử dụng.
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Mô tả:} Dịch vụ giao hàng bằng drone thương mại quy mô lớn, cung cấp giải pháp trọn gói từ drone tự hành, trạm cất/hạ cánh đến phần mềm đặt hàng và theo dõi giao hàng.
  \item \textbf{Tác nhân:}
    \begin{itemize}
      \item Khách hàng đặt hàng như y tế, bán lẻ hay thực phẩm
      \item Đối tác doanh nghiệp như nhà hàng, bệnh viện hay siêu thị
...
\begin{itemize}
  \item \textbf{FE1. Quản lý khách hàng và đơn hàng giao:} Quản lý thông tin khách hàng, địa chỉ giao hàng; tạo, cập nhật, hủy và theo dõi đơn hàng giao.
  \item \textbf{FE2. Quản lý kiện hàng và quy trình giao hàng:} Quản lý thông tin kiện hàng; phê duyệt yêu cầu, lên lịch, theo dõi tiến trình, xác nhận hoàn thành và xử lý giao hàng thất bại.
  ...
  \item \textbf{FE4. Theo dõi và xác nhận giao hàng:} Theo dõi hành trình giao hàng theo thời gian thực, xác nhận hoàn tất giao hàng.
  \item \textbf{FE5. Bảng điều khiển và dịch vụ AI:} Thống kê, báo cáo giao hàng; dự đoán thời gian đến ETA; tóm tắt thông tin giao hàng; trợ lý AI hỗ trợ khách hàng thông qua LLM API.
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{LI-04:} Không phát triển ứng dụng di động native bằng Flutter hoặc React Native; do thời gian dự án giới hạn trong 8 tuần và nhóm chưa có nhiều kinh nghiệm với mobile native, hệ thống được triển khai dưới dạng ứng dụng Web tương thích nhiều thiết bị (responsive UX), truy cập được trên cả máy tính lẫn điện thoại qua trình duyệt.
  \item \textbf{LI-05:} Không bao gồm hệ thống thanh toán trực tuyến đầy đủ bao gồm cổng thanh toán và đối soát tài chính trong phiên bản đầu tiên.
  \item \textbf{LI-06:} Không cam kết độ chính xác tuyệt đối của các dự đoán do AI cung cấp như ETA; dịch vụ AI chỉ đóng vai trò hỗ trợ ra quyết định, không thay thế con người trong các quyết định vận hành quan trọng.
  \item \textbf{LI-07:} Không triển khai trên hạ tầng sản xuất quy mô lớn; dự án tập trung xây dựng và kiểm thử hệ thống ở quy mô demo/pilot, triển khai trên Vercel cho frontend và Render cho backend.
  ...
  \item \textbf{LI-09:} Không tự triển khai và quản lý hạ tầng cơ sở dữ liệu/máy chủ tự host bằng Docker, PostgreSQL, MinIO; hệ thống sử dụng Supabase cho cơ sở dữ liệu, xác thực và lưu trữ, nhằm tối ưu thời gian phát triển.
